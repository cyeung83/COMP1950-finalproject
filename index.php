    ...
    <div class="wrapper">
        ...
        <main>
            ...
            <article>
                ...
                <button href="outline.php" class="myButton">Learn more</button>
            </article>
            ...
            <article>
                ...
                <button href="schedule.php" class="myButton">Learn more</button>
            </article>
            ...
            <article>
                ...
                <button href="lessons.php" class="myButton">Learn more</button>
            </article>
