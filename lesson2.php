        ...
        <div class="wrapper">
            ...
            <main class="lesson-main">
                ...
                <section class="lesson-content lesson-02">
                    ...
                    <ul>
                        <li>
                            <strong>Charsets</strong>
                        </li>
                        <li>
                            <strong>HTML</strong>
                            , <strong>XHTML</strong>, <strong>HTML5</strong>
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>Forms</strong>
                            , <strong>SVG</strong>, <strong>Multimedia</strong>
                        </li>
                        <li>
                            <strong>To Do</strong>
                        </li>
                    ...
                    <p>
                        <strong>Character Sets And Languages</strong>
                    </p>
                    <p>
                        The W3C recommends the
                    ...
                    <p>
                        <strong>Assign Character Set</strong>
                    </p>
                    <p>
                        If it is not specified, a web browser will choose the character set it
                        ...
                        tag to the <strong>head</strong> section of every HTML page:
                    </p>
                    <p>
                    ...
                    <ul>
                        <li>
                            Write all your text-based code (<strong>.html</strong>, <strong>.css</strong>, <strong>.js</strong>,
                            <strong>.php</strong>,
                        ...
                        <li>
                            Unless your audience includes very old browsers, you can
                        ...
                        <li>
                            You cannot copy-paste rich text (such as Microsoft Word, or WordPad)
                            into your HTML. The rich text formatting may result in an unreadable
                            mess.
                        </li>
                        <li>
                            An HTTP server can over-ride your charset preferences when it generates
                    ...
                    <p>
                        Use the <strong>lang=""</strong> attribute to
                        ...
                        over-ridden with another <strong>lang=""</strong>.
                    </p>
                    <p>
                        Use the language abbreviations from the
                        <a href="http://www.loc.gov/standards/iso639-2/php/code_list.php">
                            <strong>standard ISO 639-1</strong>
                        </a>
                        code set (don't use ISO 639-2).
                    </p>
                    <p>
                        <strong>HTML</strong>
                    </p>
                    <p>
                        What started as a language defined by<a href="http://www.w3.org/MarkUp/SGML/"><strong>SGML</strong></a>
                        <em>(Standard Generalized Markup Language)</em>, HTML is used to mark up
                        billions of pages, making up the bulk of the web.
                    </p>
                    <ul>
                        <li>
                            Late 1991, Tim Berners-Lee releases the first iteration of what would
                            become HTML 2.0 (there was no real 1.0+)
                        </li>
                        <li>
                            HTML was a language created at the dawn of the Web, using SGML
                            (Standard Generalized Markup Language) as a template
                        </li>
                        <li>
                            Over the next decade, various additions, improvements and changes are
                            introduced
                        </li>
                        <li>
                        ...
                        <li>
                            Initially used for documents and a place for the technically inclined,
                            the web did not have the international pervasiveness it does today
                        </li>
                        <li>
                            Most developers were new to the language and there were no real classes
                            in it
                        </li>
                        <li>
                    ...
                    <p>
                        <strong>HTML 4.01 template</strong>
                    </p>
                    <p>
                        The problem with the state of HTML then was its reputation as a loose
                        language. Poorly structured code would be rendered differently across user
                        agents, leading to forked code and less predictable results.
                    </p>
                    <p>
                        <strong>XHTML</strong>
                    </p>
                    <p>
                        ...
                        <a href="https://www.w3.org/TR/2002/REC-xhtml1-20020801/">
                            <strong>XHTML specification</strong>
                        </a>
                    ...
                    <ul>
                        ...
                        <li>
                            Porting to HTML5 is easy (if you also observe <strong>semantic</strong>
                            guidelines).
                        </li>
                    </ul>
                    <p>
                        <strong>XHTML Rules:</strong>
                    </p>
                    <ul>
                        <li>
                        ...
                        <ul type="circle">
                            <li>
                                This is not valid: <strong>&lt;p&gt;&lt;b&gt;Bolded Text&lt;/p&gt;&lt;/b&gt;</strong>
                            </li>
                            <li>
                                This can be a problem with things like Lists &lt;ol&gt; and
                                &lt;ul&gt;.
                            </li>
                            <li>
                                Especially when closing the List Item &lt;li&gt; tag that contains
                                the &lt;ul&gt; or &lt;ol&gt; tag.
                            </li>
                        </ul>
                        <li>
                        ...
                        <ul type="circle">
                            <li>
                                Example: <strong>&lt;p&gt;Some text here&lt;/p&gt;</strong>
                            </li>
                            <li>
                                Empty Elements are closed as well: <strong>&lt;br /&gt;</strong> or <strong>&lt;img src="#"
                                    /&gt;</strong>
                            </li>
                            <li>
                                An extra space is required before the slash to work with all
                                browsers.
                            </li>
                        </ul>
                        <li>
                        ...
                        <ul type="circle">
                            <li>
                                <strong>&lt;Img Src="some_image.gif"&gt;</strong>
                                is not valid
                            </li>
                        </ul>
                        <li>
                        ...
                        <ul type="circle">
                            <li>
                                ...
                                should be <strong>&lt;p align="center"&gt;</strong>
                            </li>
                        </ul>
                        <li>
                        ...
                        <ul type="circle">
                            <li>
                                <strong>&lt;img src="picture.gif" name="myimage" /&gt;</strong>
                                will not validate. Use <strong>id="myimage"</strong> instead.
                            </li>
                        </ul>
                        <li>
                    ...
                    <p>
                        <img border="0" width="175" height="105" src="file:////Users/a00716256/Library/Group%20Containers/UBF8T346G9.Office/msoclip1/01/clip_image001.png"
                            alt="http://bcitcomp.ca/images/comp1950_logo.png" />
                    </p>
                    <p>
